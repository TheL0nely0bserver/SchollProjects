...
function moveDino(e) {
    ...
    if ((e.code == "Space" || e.code == "ArrowUp") && dino.y == dinoY) {
        ...
        if(RunIndex < 10){
            context.drawImage(dinoDuck1, dino.x, dino.y, dino.width, dino.height);
        }    
        else if(RunIndex < 20){
            context.drawImage(dinoDuck2, dino.x, dino.y, dino.width, dino.height);
        }
    
       RunIndex = (RunIndex+1)%20;
    }
